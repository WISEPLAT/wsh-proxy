...
class Root(Resource):
    ...
    def render_POST(self, request):
        ...
        if not data.has_key('method'):
        ...
        elif data['method'] == 'wsh_submitWork' or data['method'] == 'wsh_submitHashrate':
            if self.isWorkerID:
            ...
            if data['method'] == 'wsh_submitHashrate':
            ...
            elif data['method'] == 'wsh_submitWork':
                threads.deferToThread(self.job_registry.submit, data['method'], data['params'], worker_name)
    ...
    def render_GET(self, request):
        ret_text = "Wiseplat stratum proxy<br>"
